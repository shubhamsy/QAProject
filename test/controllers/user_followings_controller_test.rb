...
class UserFollowingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_following" do
    assert_difference('UserFollowing.count') do
      post user_followings_url, params: { user_following: { follow_id: @user_following.follow_id, question_id: @user_following.question_id, user_id: @user_following.user_id } }
    end
  ...
  test "should update user_following" do
    patch user_following_url(@user_following), params: { user_following: { follow_id: @user_following.follow_id, question_id: @user_following.question_id, user_id: @user_following.user_id } }
